...
namespace LeggettAndPlatt.Extensions.Plugins.Tax
{
    ...
    public class TaxCalculatorVertex : ITaxCalculator, IDependency, IExtension
    {
      ...
      VertexTaxSettings vertexTaxSettings,IUnitOfWorkFactory unitOfWorkFactory, IOrderLineUtilities orderLineUtilities, VertexSettings vertexSettings, IVertexTaxRateService vertexTaxRateService, EmailHelper emailHelper, CommonSettings commonSettings, IEmailService emailService, CustomPropertyHelper customPropertyHelper)
        {
