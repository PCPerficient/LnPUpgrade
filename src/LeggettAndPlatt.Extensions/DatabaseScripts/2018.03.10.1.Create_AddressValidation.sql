...
UPDATE dbo.ApplicationMessage
SET Message = ''
WHERE Name = 'LNP_AddressValidationPopup_TopHeading_Msg'
End
GO
...
GO
---------------------------------------------------------------------------------------------------
if((select count(1) from [dbo].[ApplicationMessage] where name='LNP_AddressConfirmationPopup_Msg')=0)
BEGIN
INSERT INTO [dbo].[ApplicationMessage]
           ([Id]
           ,[Name]
     ...
     VALUES
           (NEWID()
           ,'LNP_AddressConfirmationPopup_Msg'
...
WHERE Name = 'LNP_AddressConfirmationPopup_Msg'
End
GO