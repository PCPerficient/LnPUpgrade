IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportStyleTraitDelta]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PRFTImportStyleTraitDelta]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportResourceDelta]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PRFTImportResourceDelta]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportProductDelta]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PRFTImportProductDelta]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportItemDelta]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PRFTImportItemDelta]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportCategoryProductLinkDelta]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PRFTImportCategoryProductLinkDelta]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportCategoryDelta]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PRFTImportCategoryDelta]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportAttributeDelta]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PRFTImportAttributeDelta]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductImageExtension_ProductImage]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductImageExtension]'))
ALTER TABLE [dbo].[PRFTProductImageExtension] DROP CONSTRAINT [FK_PRFTProductImageExtension_ProductImage]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductExtension_Product]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductExtension]'))
ALTER TABLE [dbo].[PRFTProductExtension] DROP CONSTRAINT [FK_PRFTProductExtension_Product]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductAttributeValueExtension_ProductAttributeValue]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductAttributeValueExtension]'))
ALTER TABLE [dbo].[PRFTProductAttributeValueExtension] DROP CONSTRAINT [FK_PRFTProductAttributeValueExtension_ProductAttributeValue]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTCategoryExtension_Category]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTCategoryExtension]'))
ALTER TABLE [dbo].[PRFTCategoryExtension] DROP CONSTRAINT [FK_PRFTCategoryExtension_Category]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTResourceDataFromPIM]') AND type in (N'U'))
DROP TABLE [dbo].[PRFTResourceDataFromPIM]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTProductImageExtension]') AND type in (N'U'))
DROP TABLE [dbo].[PRFTProductImageExtension]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTProductExtension]') AND type in (N'U'))
DROP TABLE [dbo].[PRFTProductExtension]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTProductAttributeValueExtension]') AND type in (N'U'))
DROP TABLE [dbo].[PRFTProductAttributeValueExtension]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTCategoryExtension]') AND type in (N'U'))
DROP TABLE [dbo].[PRFTCategoryExtension]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PIMChannelNode_Locale]') AND type in (N'U'))
DROP TABLE [dbo].[PIMChannelNode_Locale]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTCategoryExtension]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PRFTCategoryExtension](
	[ID] [uniqueidentifier] NOT NULL,
	[CategoryID] [uniqueidentifier] NOT NULL,
	[PIMEntityID] [int] NOT NULL,
	[ImagePIMResourceID] [int] NULL,
	[ImagePIMSortOrder] [int] NULL,
	[PIMChannelNodeIsActive] [bit] NULL DEFAULT ((1)),
	[PIMLinkInActive] [bit] NULL DEFAULT ((0)),
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTProductAttributeValueExtension]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PRFTProductAttributeValueExtension](
	[ProductID] [uniqueidentifier] NOT NULL,
	[AttributeValueID] [uniqueidentifier] NOT NULL,
	[PIMSourceEntityType] [varchar](10) NOT NULL,
 CONSTRAINT [PK_PRFTProductAttributeValueExtension] PRIMARY KEY CLUSTERED 
(
	[ProductID] ASC,
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTProductExtension]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PRFTProductExtension](
	[ID] [uniqueidentifier] NOT NULL,
	[ProductID] [uniqueidentifier] NOT NULL,
	[PIMProductEntityID] [int] NOT NULL,
	[PIMItemEntityID] [int] NULL,
	[PIMProductType] [nvarchar](50) NULL,
	[ProductCountryofOrigin_Value] [nvarchar](max) NULL,
 CONSTRAINT [PK_PRFTProductExtension] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
)
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTProductImageExtension]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PRFTProductImageExtension](
	[ID] [uniqueidentifier] NOT NULL,
	[ProductImageID] [uniqueidentifier] NOT NULL,
	[PIMResourceEntityID] [int] NOT NULL,
	[PIMResourceMimeType] [nvarchar](max) NULL,
 CONSTRAINT [PK_PRFTProductImageExtension] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
)
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTResourceDataFromPIM]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PRFTResourceDataFromPIM](
 ...
 CONSTRAINT [PK_PRFTResourceDataFromPIM_EntityId] PRIMARY KEY CLUSTERED 
(
	[EntityId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
)
END
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTCategoryExtension_Category]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTCategoryExtension]'))
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTCategoryExtension_Category]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTCategoryExtension]'))
ALTER TABLE [dbo].[PRFTCategoryExtension] CHECK CONSTRAINT [FK_PRFTCategoryExtension_Category]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductAttributeValueExtension_ProductAttributeValue]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductAttributeValueExtension]'))
ALTER TABLE [dbo].[PRFTProductAttributeValueExtension]  WITH CHECK ADD  CONSTRAINT [FK_PRFTProductAttributeValueExtension_ProductAttributeValue] FOREIGN KEY([ProductID], [AttributeValueID])
REFERENCES [dbo].[ProductAttributeValue] ([ProductId], [AttributeValueId])
ON DELETE CASCADE
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductAttributeValueExtension_ProductAttributeValue]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductAttributeValueExtension]'))
ALTER TABLE [dbo].[PRFTProductAttributeValueExtension] CHECK CONSTRAINT [FK_PRFTProductAttributeValueExtension_ProductAttributeValue]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductExtension_Product]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductExtension]'))
ALTER TABLE [dbo].[PRFTProductExtension]  WITH CHECK ADD  CONSTRAINT [FK_PRFTProductExtension_Product] FOREIGN KEY([ProductID])
REFERENCES [dbo].[Product] ([Id])
ON DELETE CASCADE
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductExtension_Product]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductExtension]'))
ALTER TABLE [dbo].[PRFTProductExtension] CHECK CONSTRAINT [FK_PRFTProductExtension_Product]
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductImageExtension_ProductImage]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductImageExtension]'))
ALTER TABLE [dbo].[PRFTProductImageExtension]  WITH CHECK ADD  CONSTRAINT [FK_PRFTProductImageExtension_ProductImage] FOREIGN KEY([ProductImageID])
REFERENCES [dbo].[ProductImage] ([Id])
ON DELETE CASCADE
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PRFTProductImageExtension_ProductImage]') AND parent_object_id = OBJECT_ID(N'[dbo].[PRFTProductImageExtension]'))
ALTER TABLE [dbo].[PRFTProductImageExtension] CHECK CONSTRAINT [FK_PRFTProductImageExtension_ProductImage]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportAttributeDelta]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[PRFTImportAttributeDelta] AS' 
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportCategoryDelta]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[PRFTImportCategoryDelta] AS' 
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportCategoryProductLinkDelta]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[PRFTImportCategoryProductLinkDelta] AS' 
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportItemDelta]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[PRFTImportItemDelta] AS' 
END
GO
...
print 'Action - A'
		...
		BEGIN
			SELECT
					...
					,@ShippingWeight = 
						CASE 
							...
							ELSE ISNULL(ItemBoxPackageWeight,'0') 
						END
					,@ShippingLength = 
						CASE 
							WHEN LTRIM(RTRIM(ItemBoxPackageLength)) = '' THEN 0
							ELSE ISNULL(ItemBoxPackageLength,'0') 
						END
					,@ShippingWidth = 
						CASE 
							WHEN LTRIM(RTRIM(ItemBoxPackageWidth)) = '' THEN 0
							ELSE ISNULL(ItemBoxPackageWidth,'0') 
						END
					,@ShippingHeight = 
						CASE 
							WHEN LTRIM(RTRIM(ItemBoxPackageHeight)) = '' THEN 0
							ELSE ISNULL(ItemBoxPackageHeight,'0') 
						END
			...
			ELSE IF @ProductType = 'simple'
						AND EXISTS		-- only base product data row exists, so update this with item data
							(
								SELECT 1
									FROM dbo.Product p
			...
			BEGIN
				BEGIN TRY
					...
					UPDATE dbo.Product
						SET
							Name = ISNULL(@ItemName,@ItemSKUStockNumber)
							,ShortDescription = ISNULL(@ItemName,@ItemSKUStockNumber)
							...
							,ERPNumber = ISNULL(@ItemNumber,@ItemSKUStockNumber)
							,UPCCode = @UPCCode
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportProductDelta]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[PRFTImportProductDelta] AS' 
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportResourceDelta]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[PRFTImportResourceDelta] AS' 
END
GO
...
BEGIN
	...
	WHILE @@FETCH_STATUS = 0 
	BEGIN
		IF (@CategoryId IS NULL OR ISNULL(@ResourceFilename,'') = '')
		BEGIN
			BEGIN TRY
				RAISERROR ('Custom Error - Category does not exist in Insite or Resource File Name not provided in PIM', -- Message text.  
							16, -- Severity.  
							1 -- State.  
							)
			END TRY
	...
	DECLARE Cur_ProductResourceLink CURSOR LOCAL FAST_FORWARD FOR
		SELECT
			...
			LEFT JOIN
				(
					SELECT pr.Id ProductId,pre.PIMProductEntityID,pre.PIMItemEntityID
						FROM dbo.Product pr
						INNER JOIN dbo.PRFTProductExtension pre ON pr.Id = pre.ProductID
				) p
				ON
	...
	WHILE @@FETCH_STATUS = 0 
	BEGIN
		IF (@ProductID IS NULL OR ISNULL(@ResourceFilename,'') = '')
		BEGIN
			BEGIN TRY
				RAISERROR ('Custom Error - Product does not exist in Insite or Resource File Name not provided in PIM', -- Message text.  
							16, -- Severity.  
							1 -- State.  
							)
			END TRY
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PRFTImportStyleTraitDelta]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[PRFTImportStyleTraitDelta] AS' 
END
GO
