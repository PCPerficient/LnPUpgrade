    ...
    (function (catalog) {
        ...
        var ProductListController = /** @class */ (function () {
            ...
            ProductListController.prototype.updateSearchQuery = function (params) {
                ...
                if (!Object.keys(searchParams).filter(function (o) { return o !== "pageSize" && o !== "sort" && o !== "criteria"; }).length) {
            ...
            ProductListController.prototype.cEqualize = function () {
                ...
                if ($itemBlocks.length > 0) {
                    ...
                    var actionsBlockHeight_1 = -1;
                    $itemBlocks.each(function (i, elem) {
                        var $elem = $(elem);
                        maxHeight_1 = Math.max(maxHeight_1, $elem.find(".item-inf-wrapper").height());
                        priceHeight_1 = Math.max(priceHeight_1, $elem.find(".item-price").height());
                        thumbHeight_1 = Math.max(thumbHeight_1, $elem.find(".item-thumb").height());
                        productInfoHeight_1 = Math.max(productInfoHeight_1, $elem.find(".product-info").height());
                        actionsBlockHeight_1 = Math.max(actionsBlockHeight_1, $elem.find(".actions-block").height());
                    });
                    if (maxHeight_1 > 0) {
                        priceHeight_1 = Math.max(priceHeight_1, productInfoHeight_1 + actionsBlockHeight_1);
                        $itemBlocks.each(function (i, elem) {
                            var $elem = $(elem);
                            ...
                            $elem.find(".actions-block").height(actionsBlockHeight_1);
                            $elem.addClass("eq");
                        });
                    }
                }
            ...
            ProductListController.prototype.sortedTableColumns = function (products) {
                var sortedTableColumns = products.attributeTypeFacets ? lodash.chain(products.attributeTypeFacets)
                    .sortBy(["sort", "name"])
                    .value() : [];
