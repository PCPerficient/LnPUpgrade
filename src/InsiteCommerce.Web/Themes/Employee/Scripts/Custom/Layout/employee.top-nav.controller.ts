module insite.layout {
    ...
    export interface IEmployeeTopNavControllerAttributes extends ng.IAttributes {
        dashboardUrl: string;
    }

    export class EmployeeTopNavController {
        languages: any[];
        currencies: any[];
        session: any;
        dashboardUrl: string;
        ...
        constructor(
            ...
            protected $attrs: IEmployeeTopNavControllerAttributes,
