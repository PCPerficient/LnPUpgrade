...
(function (insite) {
    ...
    (function (cart_1) {
        ...
        var CheckoutAddressController = /** @class */ (function () {
            function CheckoutAddressController($scope, $window, cartService, customerService, websiteService, coreService, queryString, accountService, settingsService, $timeout, $q, sessionService, $localStorage, $attrs, $rootScope, spinnerService) {
                this.$scope = $scope;
                this.$window = $window;
                ...
                this.firstTimeShipTostLoad = true;
                this.firstShipToSearch = true;
            }
            ...
            CheckoutAddressController.prototype.getCountriesCompleted = function (countryCollection, initAutocomplete) {
            ...
            CheckoutAddressController.prototype.setSelectedShipTo = function () {
                ...
                this.shipTos.forEach(function (shipTo) {
                    if (_this.cart.shipTo && shipTo.id === _this.cart.shipTo.id || !_this.selectedShipTo && shipTo.isNew) {
                        ...
                        _this.shipToSearch = shipTo.label;
                    }
                });
            ...
            CheckoutAddressController.prototype.updateShipTo = function (continueUri, customerWasUpdated) {
                ...
                if (this.selectedShipTo.oneTimeAddress || this.selectedShipTo.isNew) {
                    ...
                    var shipToMatches = this.loadedShipTos.filter(function (shipTo) { return shipTo.id === _this.selectedShipTo.id; });
            ...
            CheckoutAddressController.prototype.initCustomerAutocomplete = function () {
                var _this = this;
            ...
            CheckoutAddressController.prototype.onShipToAutocompleteRead = function (options) {
                var _this = this;
                this.spinnerService.show();
                this.customerService.getShipTos("excludeshowall,validation", this.firstShipToSearch ? "" : this.shipToSearch, this.getDefaultPagination(), this.cart.billTo.id).then(function (shipToCollection) { _this.getShipTosCompleted(options, shipToCollection); }, function (error) { _this.getShipTosFailed(error); });
                this.firstShipToSearch = false;
            };
            CheckoutAddressController.prototype.getShipTosCompleted = function (options, shipToCollection) {
                var _this = this;
                ...
                this.$timeout(function () { options.success(_this.shipTos); }, 0);
            };
            ...
            CheckoutAddressController.prototype.getShipToPlaceholder = function () {
