...
(function (insite) {
    ...
    (function (orderapproval) {
        ...
        var OrderApprovalDetailController = /** @class */ (function () {
            function OrderApprovalDetailController(orderApprovalService, cartService, accountService, coreService, queryString, promotionService) {
            ...
            OrderApprovalDetailController.prototype.$onInit = function () {
                ...
                this.promotionService.getCartPromotions(cartId).then(function (promotionCollection) {
            ...
            OrderApprovalDetailController.prototype.getCartPromotionsCompleted = function (promotionCollection) {
                this.promotions = promotionCollection.promotions;
            };
            OrderApprovalDetailController.prototype.getCartPromotionsFailed = function (error) {
            };
            OrderApprovalDetailController.$inject = ["orderApprovalService", "cartService", "accountService", "coreService", "queryString", "promotionService"];
